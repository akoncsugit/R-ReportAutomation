...
### Correlations
Prior to preforming any model fitting or statistical analysis it is essential to understand the potential correlation among predictors and between the response and predictors. Correlation helps identify potential colinearity and thus, allows for better canditate model selection.
```{r}
